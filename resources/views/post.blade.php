					...
					<div class="main-post">
						...
						<div class="blog-post-inner">
							...
							<ul class="tags">
                                ...
                                <li><a href="{{ route('tag.posts', $tag->slug)
								}}">{{$tag->name}}</a></li>
						...
						<div class="post-icons-area">
							...
							<ul class="icons">
								...
								<li><a href="www.pinterest.com"><i class="ion-social-pinterest"></i></a></li>
							</ul>
						</div>
								...
								<ul class="post-footer">
									...
									<li>
										...
										@else
											...
											class="{{!Auth::user()->favorite_posts->where('pivot.post_id', $randompost->id)
											->count()== 0 ? 'favorite_posts' : ''}}">
					...
					<div class="commnets-area ">
						...
						<div class="comment">
							...
							<div class="post-info">
								...
								<div class="middle-area">
									<a class="name" href="{{ route('author.profile', $post->user->username)}}"><b>{{$comment->user->name}}</b></a>
