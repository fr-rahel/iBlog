			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-section">
						...
						<a href="https://www.facebook.com/RahelMia0" target ="_blank">
						Fahedur Rahman Rahel</a></p>
						<ul class="icons">
							...
							<li><a href="https://www.vimeo.com"><i class="ion-social-vimeo-outline"></i></a></li>
							<li><a href="https://www.pinterest.com"><i class="ion-social-pinterest-outline"></i></a></li>
						</ul>
